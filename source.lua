...
local ConfigurationFolder = "Manticore"
...
function Hide()
	Debounce = true
	ManticoreLibrary:Notify("Interface Hidden","The Manticore interface has been hidden, you can unhide the interface by tapping RightShift")
